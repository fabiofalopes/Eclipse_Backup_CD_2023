...
public class MathUtilityService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://127.0.0.1:8080/MathUtilityWithRMI/services/MathUtilityPort?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(MathUtilityService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://127.0.0.1:8080/MathUtilityWithRMI/services/MathUtilityPort?wsdl");
        }
        WSDL_LOCATION = url;
    }
